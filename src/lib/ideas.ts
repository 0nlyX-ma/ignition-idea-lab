...
export const IDEAS: Record<NicheKey, Idea[]> = {
  ...
  finance: mk("fi", "finance", [
    [98.3, "I turned [Amount] into [Result] using [Strategy] (here's the exact breakdown)", "No leverage. No options. No crypto moonshot. Just a boring weekly system that compounded faster than the index for 3 years straight.", "Concrete dollar transformation + reproducible process. Finance audiences click hardest on real receipts paired with 'boring' framing — it filters out hype.", true],
    [97.6, "The [Tax Loophole] every [Income Bracket] is using (and your CPA isn't telling you)", "I asked four accountants. Three shrugged. The fourth quietly walked me through the line item that's saving her clients $14k a year.", "Conspiracy + authority gap. 'Your CPA isn't telling you' frames the viewer as the underdog being let in on the secret."],
    [96.9, "I lived on a [Amount]/month budget in [Expensive City] for [Duration]. Here's what broke.", "Two things I expected to suffer with were fine. One thing I never budgeted for nearly ended the experiment in week 3.", "Constraint + confession. Budget-challenge content has the highest comment depth in personal finance."],
    [96.2, "Stop maxing your [Account Type]. Do this instead.", "Everyone repeats the same advice. The math only works if you ignore 3 specific situations — and most people are in at least one of them.", "Sacred-cow takedown. Contrarian personal-finance advice spikes when the default rule is universally repeated.", true],
    [95.5, "I tracked every dollar for [Number] days. The [Category] number was humiliating.", "I thought I was disciplined. The spreadsheet disagreed in 4-digit fashion. The category that ate me alive wasn't food, rent, or subscriptions.", "Self-quantification + vulnerability. Specific big-number reveals are the most-shared finance hooks of 2026."],
    [94.8, "Why I cancelled [Popular Investment Product] and moved everything to [Alternative]", "Lower fees was the surface reason. The structural reason is what made me pull the trigger in a single weekend.", "Defection narrative + structural insight. Finance defections perform like SaaS defections — extremely well."],
    [94.1, "The [Number]-minute weekly money review that fixed my finances", "It's not a budget. It's not Mint. It's 4 questions I answer Sunday night that have replaced every app I used to pay for.", "Anti-app + ritual. Tired finance audiences click anti-software solutions reliably."],
    [93.5, "How I built [Amount] in passive income in [Number] months with [Capital]", "I had a runway. I did not have a trust fund. The math is honest and includes the two months where the income line went sideways.", "Aspirational + honest. Passive income content lives or dies on whether the creator shows the dip."],
    [92.9, "The [Asset Class] strategy [Famous Investor] uses that nobody copies", "It's in every interview they've given. It's in the letters. It's so unsexy nobody bothers — which is exactly why it works.", "Hidden-in-plain-sight authority. Borrowing a legendary investor's name carries decades of trust."],
    [92.3, "I paid off [Amount] of debt in [Time]. The boring math the influencers won't show.", "No side hustle. No crypto. No 'manifest abundance.' One spreadsheet, one schedule, and one decision I made on a Tuesday in March.", "Anti-hype + receipts. Debt-payoff narratives are the highest-trust format in finance.", true],
    [91.6, "Your [Retirement Account] is doing this thing nobody warned you about", "I noticed it on my own statement. I called three brokers. Two had no idea. The third confirmed it costs the average saver $40k+ over 30 years.", "Discovery + dollar stakes. 'Nobody warned you' triggers loss-aversion harder than any other finance frame."],
    [91.0, "I asked [Number] millionaires what they wish they'd done at [Age]. The answers shocked me.", "It wasn't 'invest earlier.' It wasn't 'start a business.' Two of the three most common answers had nothing to do with money at all.", "Cross-source pattern + negation. Telling viewers what the answer ISN'T fuels the click."],
    [90.4, "The [Amount] mistake that taught me more than any finance book", "I lost it in 11 minutes. I learned more in those 11 minutes than I had in 4 years of YouTube videos and 3 books. Here's the lesson, free.", "Sacrifice + gift. Audiences trust hard-won lessons over polished tutorials."],
    [89.8, "Why [Common Asset] is the worst investment of your life (with the math)", "Everyone tells you it appreciates. Everyone is comparing it to the wrong baseline. Here's the chart your parents don't want to see.", "Generational reframe + visual proof. Anti-conventional-wisdom finance content overperforms in slow markets."],
    [89.2, "I built a [Amount]/month side income with [Number] hours a week — full spreadsheet", "Spreadsheet linked. Numbers unedited. The month where I almost quit is the most useful row in the whole sheet.", "Free artifact + transparency. Sharing the actual spreadsheet is the modern receipts standard."],
    [88.6, "Stop using [Budgeting App]. This free spreadsheet beats it.", "I tried every paid app. I rebuilt the best parts into 6 tabs that take 10 minutes to set up and never charge you for 'premium insights.'", "Anti-subscription + giveaway. Personal-finance audiences are unusually receptive to anti-app messaging.", true],
  ]),

  fitness: mk("ft", "fitness", [
    [98.2, "I trained like [Person/Method] for [Duration] and this happened to my [Metric]", "Day 7 I almost quit. Day 19 something flipped — and the result wasn't the one I was chasing. It was the one I actually needed.", "Authority steal + transformation arc + surprise metric. Fitness's three highest-converting hooks layered into one title.", true],
    [97.5, "The [Number]-minute morning routine that replaced my [Expensive Thing]", "It's not stretching. It's not cold plunges. It's a 4-movement sequence that took me from 3-day-a-week soreness to zero in two weeks.", "Cost replacement + negation. Telling viewers what it ISN'T builds the curiosity gap."],
    [96.8, "Why every rep of your [Exercise] is wasted (and the 1 cue that fixes it)", "I coached 40 athletes through this fix. Every single one added weight to their working set within a session.", "Outrage + immediate fix. 'Wasted' triggers loss-aversion in lifters who care about progress."],
    [96.1, "I tried [Famous Athlete]'s exact workout for [Duration]. I'm not the same person.", "I expected to look different. I didn't expect to think different. The mental side of their program is the part nobody copies.", "Celebrity protocol + identity shift. Pulling in fitness fans and personal-development viewers simultaneously.", true],
    [95.4, "The [Diet] mistake that's quietly killing your [Goal]", "It's not the macros. It's not the timing. It's a single ingredient hidden in 'healthy' foods that wrecks recovery for the average lifter.", "Hidden saboteur. 'Quietly killing' is one of fitness YouTube's highest-CTR phrases."],
    [94.8, "I ran [Distance] every day for [Days] days. My body did something unexpected.", "Week 1 was misery. Week 3 I stopped wanting sugar entirely. Week 6 I noticed something in the mirror I hadn't seen in a decade.", "Streak experiment + bodily reveal. Daily-challenge content is reliably evergreen for fitness audiences."],
    [94.1, "Stop doing [Popular Exercise]. Do [Underrated Exercise] instead.", "Same muscle. Better mechanics. One-third of the joint stress. I switched my entire program around it and added 30 lbs to my lift in 8 weeks.", "Imperative swap + result. Anti-popular-movement content has high comment engagement."],
    [93.5, "How I lost [Amount] of [Body Composition] in [Time] without [Common Restriction]", "No crash diet. No 6am cardio. Just three rules and one weekly weigh-in habit that kept the scale honest.", "Goal + freedom from restriction. The 'without' clause is the entire hook.", true],
    [92.8, "The [Number]-second test that tells you if your [Body Part] is about to fail", "I learned it from a PT who works with NBA centers. If you can't pass it cleanly, you're a torn ligament away from a 6-month rebuild.", "Injury prevention + insider authority. Pro-athlete-adjacent advice carries outsized trust."],
    [92.1, "I went to the gym at [Unusual Time] for [Days] days. My results doubled.", "Same program. Same calories. Different clock. The biological reason this worked is wilder than the productivity reason — and I'll cover both.", "Counterintuitive schedule + science promise. Chronobiology fitness content is surging."],
    [91.5, "Why [Famous Coach]'s [Program] doesn't work for [Demographic]", "I followed it to the letter for 12 weeks. I got weaker. Here's the missing variable that makes it brilliant for one group and brutal for another.", "Authority critique + personalization. Caveat-content earns trust faster than pure praise."],
    [90.9, "The [Number] supplements I quit (and the [Number] I added)", "Cancelled $180/mo of fancy bottles. Added 3 things you can buy at any grocery store. Bloodwork at the end of the video.", "Cost-cutting + verifiable proof. Bloodwork-as-receipt is the new transformation photo."],
    [90.3, "I trained only [Body Part] for 30 days. Here's what changed everywhere else.", "I expected one obvious change. I got six unexpected ones — and one that genuinely scared me until I understood the mechanism.", "Single-variable experiment + ripple effect. Isolated-training content gets unusually high save rates."],
    [89.7, "The recovery hack that beat [Expensive Modality] in my own data", "I have a $4k device. I have a 3-minute habit. The 3-minute habit out-recovered the device by 18% over a 60-day trial — and I have the HRV data to prove it.", "Cheap-beats-expensive + data. Quantified-self fitness content scores extremely high in 2026."],
    [89.1, "I copied [Sport Athlete]'s diet for [Time] — even the weird parts", "There were definitely weird parts. Two of them turned out to be the secret. One of them I'll never do again. Full grocery list in the description.", "Celebrity diet + free artifact. Diet-replication content is reliably high-LTV."],
    [88.5, "Your [Wearable] is lying about your [Metric]. Here's how to know.", "I wore three devices for 60 days against a gold-standard lab test. The cheapest one was the most accurate. The most popular was the worst.", "Trust collapse + receipts. Wearable-comparison content has explosive share rates among fitness enthusiasts.", true],
  ]),
};
